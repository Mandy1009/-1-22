...
<div class="h1"></div>
        ...
        <div class="card-columns cardsIn ">
            ...
            <img class="card-img-top" src="./img<?= $row["cPic"]?>" alt="class01">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                    <?= $row["cDescribe"]?></p>
                    <a href="#regmark" class="btn" onclick="Regist()">報名此課程</a>
                </div>
            </div>
            <?php endwhile; ?>
    ...
    <div class="form-bg" >
        ...
        <form class="registration_form" method="post" action="" id="regmark">
...
function nav() {
            var rwdnav = document.getElementById('navDiv');
            // console.log(rwdnav);
            if (rwdnav.style.display == "none") {
                rwdnav.style.display = "block";
            }
            else {
                rwdnav.style.display = "none";
